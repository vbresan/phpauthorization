<?php
// $Id: Log.php,v 1.1 2009/06/17 15:23:55 viktor Exp $
...
class epLib_Log
{
                     ...
                     $maxLevel = PEAR_LOG_DEBUG)
    {
        ...
        $class = 'epLib_Log_' . $type;
        $classfile = dirname(__FILE__) . '/Log/' . $type . '.php';
                        ...
                        $maxLevel = PEAR_LOG_DEBUG)
    {
        ...
        if (!isset($instances[$signature])) {
            $instances[$signature] = &epLib_Log::factory($type, $name, $ident, $conf,
                $maxLevel);
        }
