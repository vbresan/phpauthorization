<?php
// $Id: composite.php,v 1.1 2009/06/17 15:24:02 viktor Exp $
...
class epLib_Log_composite extends epLib_Log
{
    /**
     ...
     * @access public
     */
    function epLib_Log_composite($name = false, $ident = false, $conf = false,
    ...
    function removeChild($child)
    {
        ...
        if (!is_a($child, 'epLib_Log') || !isset($this->_children[$child->_id])) {
            return false;
        }
